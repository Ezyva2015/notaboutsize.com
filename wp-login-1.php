...
if ( force_ssl_admin() && ! is_ssl() ) {
	if ( 0 === strpos($_SERVER['REQUEST_URI'], 'http') ) {
		...
		echo " <h1> logging in now if </h1>";
		// wp_redirect( set_url_scheme( $_SERVER['REQUEST_URI'], 'https' ) );
		exit();
	} else {

		echo "<h1>logging in now! else</h1>";
...
<?php		exit;
	...
	login_header(__('Log In'), '', $errors); // <--- edit logo here
...
?>
<h1> Login area</h1>
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login-1.php', 'login_post' ) ); ?>" method="post">
	<p>
		<label for="user_login"><?php _e('Username') ?><br />
