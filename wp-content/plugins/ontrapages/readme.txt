...
ONTRApages for WordPress allows ONTRAPORT & ONTRApages.com users to connect to their accounts and easily host their landing pages on their own WordPress sites. Get your free ONTRApages.com account today.
...
Yes. You need an ONTRAPORT account to generate API credentials that you will use to pull in your ONTRApages. ONTRApages.com accounts don't currently allow users to generate API credentials.

= Will you ever support ONTRApages.com accounts? =

Yes! Very soon.

= Where can I learn more about ONTRApages? =

Visit ONTRApages.com for more information about ONTRApages.

= Anywhere I can go to learn more or get support information? =

Yes! Visit answers.ontraport.com.
